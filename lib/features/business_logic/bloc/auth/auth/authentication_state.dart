...
class AuthenticationState extends Equatable {
  ...
  const AuthenticationState.authenticated(Authentication authenticationUser)
      : this._(
  ...
  const AuthenticationState.firstTimeAppOpened()
      : this._(authenticationStatus: AuthenticationStatus.firstTimeAppOpened);
