...
import 'package:hesham/features/presentation/screen/home/demo_home_screen.dart';
...
import 'package:hesham/features/presentation/screen/home/update_app_screen.dart';
...
class AppRouterImpl implements AppRouter {
  ...
  Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.homeDeomRoot:
        di.homeModule();
        return _routePage(screen: const HomeDeomScreen(), settings: settings);
      ...
      case Routes.classPdfShow:
        return _routePage(
            screen: PdfViewFile(url: settings.arguments as String),
            settings: settings);
      ...
      case Routes.classScreenMaterialShow:
        return _routePage(
            screen: const ClassScreenMaterial(), settings: settings);
      case Routes.landScapeScreen:
        return _routePage(
            screen: const LandScapeModeScreen(), settings: settings);
      case Routes.maintainAppRoot:
        return _routePage(
            screen: const MaintainAppScreen(), settings: settings);
      case Routes.updateAppRoot:
        return _routePage(screen: const UpdateAppScreen(), settings: settings);
