      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'الدروس',
            style:
                TextStyle(color: Colors.white, fontSize: FontSize.fontSize16),
          ),
          leading: IconButton(
            icon: const Icon(
...
class Content extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
        ...
        onRefresh: () async {
          Courses courses =
              ModalRoute.of(context)!.settings.arguments as Courses;
                    ...
                    child: SizedBox(
                      ...
                      child: ListTile(
                        onTap: () => showBottomSheet(context,
                            courses.lessons[index], instance<HomeBloc>()),
                        title: Text(
                          AppLocalizationsImpl.of(context)!
                              .translate(courses.lessons[index].title),
...
showBottomSheet(
    BuildContext mainContext, Lesson lesson, HomeBloc homeBloc) async {
      ...
      return Visibility(
        ...
        replacement: SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: () => context
                .read<HomeBloc>()
                .add(SheetLessonEvent(lesson, state.file!)),
            child: Text(
                AppLocalizationsImpl.of(context)!.translate(AppStrings.save)),
          ),
        ),
        child: SizedBox(
...
class HomeWorkAnswer extends StatelessWidget {
  ...
  final Lesson lesson;
  const HomeWorkAnswer({Key? key, required this.homeBloc, required this.lesson})
      : super(key: key);
        ...
        listener: (context, state) {
          {
            if (state.statePage == StatePage.data) {
              if (state.isUploaded == true) {
                instance<ShowMessage>()
                    .showSnakeBar(context, AppStrings.success);
            ...
            if (state.statePage == StatePage.error) {
              if (state.failure.code == 2020) {
                instance<ShowMessage>().showErrorPopupRetry(
                    context, state.failure.message, () async {
                  {
              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      AppLocalizationsImpl.of(context)!.translate('upload'),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.of(context)
          .pushNamed(Routes.classScreenMaterialShow, arguments: lesson),
      child: SizedBox(
        height: AppSize.appSize80,
        width: context.width * AppSize.appSize0_30,
        child: Card(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizationsImpl.of(context)!.translate('material'),
                textAlign: TextAlign.center,
        ...
        child: Card(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizationsImpl.of(context)!.translate('download'),
                style: Theme.of(context).textTheme.headlineSmall!.copyWith(
                    color: Colors.white, fontSize: FontSize.fontSize12),
              )
            ],
